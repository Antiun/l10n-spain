function l10n_es_pos_simplified_invoice_widgets(instance, module){ //module is instance.point_of_sale
    ...
    module.ProductListWidget = module.PosBaseWidget.extend({
        ...
        get_product_price_with_tax: function(product){
            ...
            product.price_with_tax = (product.list_price + (product.list_price * total_amount)).toFixed(2)
        },
        ...
        render_product: function(product){
            ...
            if(!cached){
                ...
                var product_html = QWeb.render('Product_l10n_es',{
                        widget:  this,
                        product: product,
